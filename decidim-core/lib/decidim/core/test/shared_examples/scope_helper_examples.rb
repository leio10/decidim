...
shared_examples "scope helpers" do
  ...
  let(:component) { create(:component, manifest_name: "dummy", participatory_space: participatory_space, settings: {scopes_enabled: scopes_enabled, scope_id: component_scope&.id}) }
